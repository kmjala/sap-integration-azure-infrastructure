import { SAPMaterialMasterServiceBusReceiverHandlerV2 } from "../../src/functions/SAPMaterialMasterServiceBusReceiverV2";
import { InvocationContext } from "@azure/functions";
import * as fs from "fs";
import getProductMasterSinglePlantSAPAPIResponseMock from "../resources/SAPMaterialMasterServiceBusReceiverV2/sap-api-get-product-master-single-plant-mock.json";
import getProductMasterMultiplePlantsSAPAPIResponseMock from "../resources/SAPMaterialMasterServiceBusReceiverV2/sap-api-get-product-master-multiple-plants-mock.json";
import getProductMasterNoPlantSAPAPIResponseMock from "../resources/SAPMaterialMasterServiceBusReceiverV2/sap-api-get-product-master-no-plant-data-mock.json";
import getProductMasterLongNumberSAPAPIResponseMock from "../resources/SAPMaterialMasterServiceBusReceiverV2/sap-api-get-product-master-material-number-long-mock.json";
import getCharacteristicDescriptionSAPAPIResponseMock from "../resources/SAPMaterialMasterServiceBusReceiverV2/sap-api-get-characteristic-description-mock.json";
import getProductMasterMultiplePlantsWithoutAssignmentsSAPAPIResponseMock from "../resources/SAPMaterialMasterServiceBusReceiverV2/sap-api-get-product-master-multiple-plants-without-assignments-mock.json";
import expectedSinglePlantJSON from "../resources/SAPMaterialMasterServiceBusReceiverV2/expected-single-plant.json";
import expectedMultiplePlantsJSON from "../resources/SAPMaterialMasterServiceBusReceiverV2/expected-multiple-plants.json";
import expectedMultiplePlantsEmptyClassAssignmentsJSON from "../resources/SAPMaterialMasterServiceBusReceiverV2/expected-multiple-plants-no-class-assignments.json";
import expectedMaterialNumberLongJSON from "../resources/SAPMaterialMasterServiceBusReceiverV2/expected-material-number-long.json";
import expectedNoPlantDataJSON from "../resources/SAPMaterialMasterServiceBusReceiverV2/expected-no-plant-data.json";
import {
...
describe("SAP Material Master Service Bus Receiver Test", () => {
  ...
  it("should successfully build Material Master message with a single plant", async () => {
    const context = new InvocationContext({
      functionName: "SAPMaterialMasterServiceBusReceiverV2",
      triggerMetadata: {
    ...
    const xmlFile = fs.readFileSync(
      __dirname +
        "/../resources/SAPMaterialMasterServiceBusReceiverV2/input-single-plant.xml",
      "utf8",
    );

    // Invoke the handler
    await SAPMaterialMasterServiceBusReceiverHandlerV2(xmlFile, context);
  ...
  it("should successfully build Material Master message with a multiple plants", async () => {
    ...
    const xmlFile = fs.readFileSync(
      __dirname +
        "/../resources/SAPMaterialMasterServiceBusReceiverV2/input-multiple-plants.xml",
      "utf8",
    );
  ...
  it("should use MATNR_LONG as Material Number because MATNR is empty", async () => {
    ...
    const xmlFile = fs.readFileSync(
      __dirname +
        "/../resources/SAPMaterialMasterServiceBusReceiverV2/input-material-number-long.xml",
      "utf8",
    );
  ...
  it("should not skip empty Plant Data", async () => {
    ...
    const xmlFile = fs.readFileSync(
      __dirname +
        "/../resources/SAPMaterialMasterServiceBusReceiverV2/input-no-plant-data.xml",
      "utf8",
    );
